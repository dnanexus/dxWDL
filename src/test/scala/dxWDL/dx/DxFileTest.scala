...
//  }
  ...
  it should "describe job" in {
    //    {"analysis":null,"created":1593174588426,"id":"job-FqpyZP00k25Q2Kp5B0JV8Yv4","modified":1593174740460,"name":"printPerson","parentJob":null,"project":"project-FpGpg8Q0k25YQ1k53YF8YxkG"}
    val dxJob = DxJob("job-FqpyZP00k25Q2Kp5B0JV8Yv4", Some(DxProject("project-FpGpg8Q0k25YQ1k53YF8YxkG"))) //app
    print(dxJob.describe())
    val dxJob2 = DxJob("job-Fqpyv100k25Q2Kp5B0JV8Z1f", Some(DxProject("project-FpGpg8Q0k25YQ1k53YF8YxkG"))) //applet
    print(dxJob2.describe())
  }
}
