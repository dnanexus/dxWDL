// This code is a modification of the TypeEvaluator from
//    https://github.com/broadinstitute/wdl4s/blob/develop/wom/src/main/scala/wdl/expression/TypeEvaluator.scala
//
package dxWDL
...
case class TypeEvaluator(override val lookup: String => WdlType,
                         override val functions: WdlFunctions[WdlType],
                         from: Option[Scope] = None) extends Evaluator {
