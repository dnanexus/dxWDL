...
fragments* are used in this support role. A *fragment* is a section
of the workflow that contains a series of declarations, followed by
at most one asynchronous call. A *fragment runner* is an applet, generated by
the compiler, which can execute such a fragment on the dnanexus platform.
...
|-------  | -----  | ----      |
| Inputs  |        |     flag, x, y  |
| Stage 1 | applet fragment-if-flag | flag, x |
| Stage 2 | applet fragment-if-!flag | flag, x, y |
